...
const RadialBarChartView = (props) => {
    ...
    return (
        <ResponsiveContainer width="100%" height={300}>
            <RadialBarChart cx="50%" cy="40%" innerRadius="30%" outerRadius="90%" data={data} startAngle={90} endAngle={-180}>
                <RadialBar minAngle={20} label={{ fill: '#000', position: 'insideStart' }} clockWise={true} background dataKey="value" />
